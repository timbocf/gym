...
<div class="container">
    ...
    <div class="row">
        ...
        <div class="col-lg-6"> 
            ...
            <!-- <img src="<?php // bloginfo('template_directory') ?>/images/welcome.jpg" id="welcome" alt="Welcome to Gym 101 Fitness Center!" title="Welcome to GYM 101 Fitness Center!" /> -->

            <div id="welcome">

                <h1>Welcome to Gym 101 Fitness Center!</h2>

            </div>

            <div id="whoweare">

                <h2>Open <span class="orange">24&nbsp;hrs</span>!</h2>
